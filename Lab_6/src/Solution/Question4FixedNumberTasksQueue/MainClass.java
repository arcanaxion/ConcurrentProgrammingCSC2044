...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        Computer c1 = new Computer(printingQueue,2,"C1");
        Computer c2 = new Computer(printingQueue,2,"C2");
        Computer c3 = new Computer(printingQueue,2,"C3");
        Computer c4 = new Computer(printingQueue,2,"C4");
        Computer c5 = new Computer(printingQueue,2,"C5");
        Computer c6 = new Computer(printingQueue,2,"C6");
        Computer c7 = new Computer(printingQueue,2,"C7");
        Computer c8 = new Computer(printingQueue,2,"C8");
        Computer c9 = new Computer(printingQueue,2,"C9");
        Computer c10 = new Computer(printingQueue,2,"C10");     
